...
<head>
    ...
    <style>
        ...
        .cloud {
            ...
            width: 60%;
            height: 100%;
            background: linear-gradient(to bottom, #ffffff 0%, #f6efe8 100%);
            overflow: hidden;
        }

        /* Buat bentuk awan pakai pseudo element */
        .cloud::before,
        .cloud::after {
            content: "";
            position: absolute;
        ...
        .cloud.left {
            left: 0;
            animation: cloudLeft 3s ease-in-out forwards;
        }

        /* Kanan */
        .cloud.right {
            right: 0;
            animation: cloudRight 3s ease-in-out forwards;
        }
        ...
        #cover {
            ...
            background-image: url('./images/mrgallery1.png');
        ...
        .thank-section {
            position: relative;
            background-image: url('./images/alobgthank.png');
            background-size: cover;
            background-position: center;
            width: 100%;
            height: 100vh;
...
<body>
    ...
    <div id="cover" data-aos="fade-up" data-aos-duration="3500">
        <div class="cover-content">
            ...
            {{-- <div class="center-logo">
                <img id="patern7" src="./images/mypatm.png" alt="center logo" data-aos="fade-up" data-aos-delay="300"
            ...
            <div class="cover-sub-title d-flex flex-row justify-content-between">
                ...
                <div class="text-center content-sub-title">
                    <h5 class="sub-title split-text mb-3">Saturday, <span class="num">12</span>&nbsp;Mei&nbsp;<span
                            class="num">2026</span>
                    </h5>
                    ...
                    <button class="open-btn mt-4" onclick="openInvitation()">
                        <img src="./images/aloopenbtn.png" alt="">
    ...
    <div id="page">
        ...
        <section class="first-section d-flex flex-column" data-aos="fade-up">
            <div class="wedding-card">
                ...
                <div class="content d-flex flex-column justify-center mt-4 ">
                    ...
                    <div class="d-flex justify-content-center gap-3 text-uppercase mb-4">
                        <h1>Fulan</h1>
                        <p class="and">&</p>
                        <h1>Annisa</h1>
                    </div>
                    <div
                        class="date-card-container d-flex flex-column justify-content-center align-items-center gap-3 mt-2">
        ...
        <div class="div-content pt-1">
            <section class="bio-secetion pt-5 px-1 d-flex flex-column align-items-center justify-content-between">
                <div class="groom row mx-0 pt-1" data-aos="fade-right" data-aos-delay="500">
                ...
                <div class="bride row mx-0" data-aos="fade-left" data-aos-delay="600">
                    ...
                    <div class="bio-bride-image p-2 col-6 d-flex justify-content-end">
            ...
            <section class="love-stories-section pt-3">
                <div class="pattern-first-section mb-2">
                    <img id="patern20" src="./images/alpat.png" alt="pattern20" data-aos="fade-down"
                        data-aos-delay="600">
                </div>
            ...
            <section class="wish-section" data-aos="fade-up" data-aos-delay="500">
                <form class="wish-form" id="wishForm">
                    <h2 class="text-center">MAKE A WISH</h2>

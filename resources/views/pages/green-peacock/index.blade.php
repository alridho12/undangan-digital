...
<head>
    ...
    <style>
        ...
        #cover {
            ...
            width: 100%;
            height: 100vh;
            background-color: #3dc468;
            background-image: url('./images/bgds4.png');
        ...
        .first-section {
            ...
            ;
            background-image: url('./images/bgwcd4.png');
            background-size: cover;
            background-position: bottom center;
        ...
        .profile {
            background-image: url('./images/bgprofiled4.png');
        ...
        .invitation-info {
            background-image: url('./images/bginfod4.png');
            background-position: bottom center;
            background-size: cover;
        ...
        .reception-info {
            background-color: #fbfff2;
            background-image: url('./images/bgrd4.png');
            background-position: bottom center;
        ...
        .love-stories-section {
            background-image: url('./images/bglsd4.png');
        ...
        .thanks-section {
            background-image: url('./images/bgtkd4.png');
            background-position: bottom center;
            background-size: cover;
...
<body>
        ...
        <div class="cover-content">
            ...
            <div class="middle-patern">
                ...
                <div class="right-middle-patern" data-aos="fade-left" data-aos-delay="300" data-aos-duration="2200">
                    <img id="paternr1" src="./images/pmr1d4.png" alt="pattern5">
                    <img id="paternr2" src="./images/pmr2d4.png" alt="pattern5">
                </div>
            </div>

            <div class="bottom-patern">
                <div class="center-bottom-patern" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1200">
                    <img id="patern6" src="./images/pbd4.png" alt="pattern6">
                </div>
            </div>
        </div>
    </div>
    ...
    <section id="mainContent" class="first-section flex-column">
        <video autoplay muted class="bg-video" id="bgVideo">
            <source src="./video/design4.mp4" type="video/mp4">
        </video>
        ...
        <div class="top-patern-wc">
            <div class="left-top-patern-wc fade-right-custom">
                <img src="./images/ltwcd4.png" id="patern7" alt="pattern7">
            </div>
            <div class="right-top-patern-wc fade-left-custom">
                <img src="./images/rtwcd4.png" id="patern7" alt="pattern7">
            </div>
        </div>
        <div class="wedding-card py-3">
            <div class="left-patern-wc fade-right-custom">
                <img id="patern8" src="./images/wcmdld4.png" alt="pattern8">
            </div>
            <div class="middle-patern-wc">
                <img id="wedding-card-bg" src="./images/wcmdfd4.png" alt="Wedding Card">
                <div class="text-content">
                    <p class="subtitle">The Wedding of</p>
                    <h1>STEVEN <br>&<br> ELIZABETH</h1>
                    <div class="date my-4">
                        <img src="./images/dd4.png" alt="">
            ...
            <div class="right-patern-wc fade-left-custom">
                <img id="patern9" src="./images/wcmdrd4.png" alt="pattern9">
            </div>
        </div>
    </section>
        ...
        <section class="invitation-info">
            <div class="invitation-info-content">
                ...
                <div class="patern-info" data-aos="fade-up" data-aos-delay="300" data-aos-duration="2200">
                    <img src="./images/ptid4.png" alt="pattern info">
                </div>
                <div class="space"></div>
                ...
                <div class="reception-info" data-aos="fade-up" data-aos-delay="300" data-aos-duration="2200">
                    <div class="reception-content">
                        ...
                        <div class="patern-reception">
                            <img src="./images/prd4.png" alt="Pattern Reception">
                        </div>
                        <div class="reception-text">

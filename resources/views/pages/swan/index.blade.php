...
<head>
    ...
    <style>
        ...
        #cover {
            ...
            background-image: url('./images/bgds1.png');
        ...
        .first-section {
            ...
            z-index: 1;
            top: 0;
            background-color: #829a4d;
            background-image: url('./images/bgwcd1.png');
            background-size: cover;
            background-position: center;
        ...
        .profile {
            background-image: url('./images/bgprofiled1.png');
        ...
        .invitation-info {
            background-image: url('./images/bginfod1.png');
        ...
        .love-stories-section {
            background-image: url('./images/bglsd1.png');
        ...
        .thanks-section {
            background-image: url('./images/bgtkd1.png');
            background-position: bottom center;
            background-size: cover;
...
<body>
        ...
        <div class="cover-content">
            <div class="top-patern">
                <div class="left-top-patern" data-aos="fade-right" data-aos-delay="300" data-aos-duration="2200">
                    <img id="patern1" src="./images/ltcd1.png" alt="pattern1">
                </div>
                <div class="center-top-patern">
                    <img id="patern2" src="./images/ctcd1.png" alt="pattern2" data-aos="fade-down"
                ...
                <div class="right-top-patern" data-aos="fade-left" data-aos-delay="300" data-aos-duration="2200">
                    <img id="patern3" src="./images/rtcd1.png" alt="pattern3">
                </div>
            </div>
            <div class="middle-patern">
                <div class="left-middle-patern">
                    <img id="paternm" src="./images/lmd1.png" alt="pattern4" data-aos="fade-right"
                        data-aos-delay="300" data-aos-duration="2200">
                </div>
                    ...
                    <div class="patern-header px-3 py-5" data-aos="fade-up" data-aos-delay="300"
                        ...
                        <div class="text-center">
                            ...
                            <div class="open-btn-content mx-auto">
                                <button class="open-btn" onclick="openInvitation()" data-aos="fade-up"
                                    data-aos-delay="300" data-aos-duration="2200">
            ...
            <div class="bottom-patern">
                <div class="left-bottom-patern">
                    <img id="patern4" src="./images/mlcd1.png" alt="pattern4" data-aos="fade-right"
                        data-aos-delay="300" data-aos-duration="2200">
                </div>
                <div class="center-bottom-patern" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1200">
                    <img id="patern6" src="./images/btcd1.png" alt="pattern6">
                    <img id="swan" src="./images/swan.png" alt="swan">
                </div>
                <div class="right-bottom-patern">
                    <img id="patern5" src="./images/mrcd1.png" alt="pattern5" data-aos="fade-left"
                        data-aos-delay="300" data-aos-duration="2200">
                </div>
            </div>
        </div>
    ...
    <!-- MAIN CONTENT -->
    <section id="mainContent" class="first-section flex-column" data-aos="fade-up">
        <video autoplay muted playsinline class="bg-video">
            <source src="./video/design1.mp4"
                type="video/mp4">
        </video>
        ...
        <div class="top-patern-wc" data-aos="fade-down" data-aos-delay="300" data-aos-duration="2200">
            <img src="./images/twcd1.png" id="patern7" alt="pattern7">
        </div>
        <div class="wedding-card py-3">
            <div class="left-patern-wc" data-aos="fade-right" data-aos-delay="300" data-aos-duration="2200">
                <img id="patern8" src="./images/wcmdld1.png" alt="pattern8">
            </div>
            <div class="middle-patern-wc">
                <img id="wedding-card-bg" src="./images/wcmdfd1.png" alt="Wedding Card">
            ...
            <div class="right-patern-wc" data-aos="fade-left" data-aos-delay="300" data-aos-duration="2200">
                <img id="patern9" src="./images/wcmdrd1.png" alt="pattern9">
            </div>
        </div>
    </section>
        ...
        <section class="invitation-info">
            <div class="invitation-info-content">
                ...
                <div class="patern-info" data-aos="fade-up" data-aos-delay="300" data-aos-duration="2200">
                    <img src="./images/ptid1.png" alt="pattern info">
                </div>
                <div class="space"></div>
        ...
        <section class="galery-section">
            <div class="galery-content">
                ...
                <div class="galery-img">
                    ...
                    <div class="galery-img-item full" data-aos="fade-up" data-aos-delay="300" data-aos-duration="2200">
